(function(a) {
    function u(j, b) {
        ...
        function m(a) {
            ...
            for (b in $[a])
                0 == c % 20 && (j += '</div><div class="dw-bf">'), j += '<div class="dw-li dw-v" data-val="' + b + '" style="height:' + M + "px;line-height:" + M + 'px;"><div class="dw-i">' + $[a][b] + "</div></div>", c++;
            return j + "</div>"
        }
        function q(j) {
        ...
        function o(j, c, b, f, i) {
            !1 !== N("validate", [z, c, j]) && (a(".dw-ul", z).each(function(b) {
                ...
                if (!e.hasClass("dw-v")) {
                    for (var I = e, m = 0, q = 0; 0 <= g - m && !I.hasClass("dw-v"); )
                        m++, 
                        I = h.eq(g - m);
                    for (; g + q < p && !e.hasClass("dw-v"); )
                        q++, e = h.eq(g + q);
                    (q < m && q && 2 !== f || !m || 0 > g - m || 1 == f) && e.hasClass("dw-v") ? g += q : (e = I, g -= m)
                }
                if (!e.hasClass("dw-sel") || l)
                    n.temp[b] = e.attr("data-val"), a(".dw-sel", d).removeClass("dw-sel"), e.addClass("dw-sel"), n.scroll(d, b, g, l ? j : 0.1, l ? i : void 0)
            }), n.change(b))
        }
        function u(j) {
            if (!("inline" == p.display || S === a(window).width() && ca === a(window).height() && j)) {
                ...
                n.left = b;
                I.css(n);
                a(".dw-persp", z).height(0).height('auto');
        ...
        n.getValues = function() {
            var a = [], j;
            for (j in n._selectedValues)
                a.push(n._selectedValues[j]);
            return a
        };
        ...
        n.show = function(j) {
            ...
            var b = 0, e, f = "";
            T && !j && (f = "dw-" + T + " dw-in");
            for (var d = '<div class="dw-trans ' + p.theme + " dw-" + p.display + '">' + ("inline" == p.display ? '<div class="dw dwbg dwi"><div class="dwwr">' : '<div class="dw-persp"><div class="dw dwbg ' + f + '"><div class="dw-arrw"><div class="dw-arrw-i"><div class="dw-arr"></div></div></div><div class="dwwr">' + (p.headerText ? '<div class="dwv"></div>' : "")), j = 0; j < p.wheels.length; j++) {
                d += '<div class="dwc' + ("scroller" != 
                p.mode ? " dwpm" : " dwsc") + (p.showLabel ? "" : " dwhl") + '"><div class="dwwc dwrc"><table cellpadding="0" cellspacing="0"><tr>';
                for (e in p.wheels[j])
                    $[b] = p.wheels[j][e], d += '<td><div class="dwwl dwrc dwwl' + b + '">' + ("scroller" != p.mode ? '<div class="dwwb dwwbp" style="height:' + M + "px;line-height:" + M + 'px;"><span>+</span></div><div class="dwwb dwwbm" style="height:' + M + "px;line-height:" + M + 'px;"><span>&ndash;</span></div>' : "") + '<div class="dwl">' + e + '</div><div class="dww" style="height:' + p.rows * M + "px;min-width:" + p.width + 
        ...
        n.init = function(a) {
            ...
            n.settings = p;
            G.unbind(".dw");
            if (a = da.presets[p.preset])
                aa = a.call(R, n), H(p, aa, b), H(ba, aa.methods);
            ha = Math.floor(p.rows / 2);
            M = p.height;
            T = p.animate;
            void 0 !== G.data("dwro") && (R.readOnly = U(G.data("dwro")));
            X && n.hide();
            "inline" == p.display ? n.show() : (k(), Y && p.showOnFocus && (G.data("dwro", R.readOnly), R.readOnly = !0, n.show(), G.bind("click.dw", function() {
                n.show()
            })))
        };
    ...
    var g = {}, C, r = function() {
        ...
        F = !0
    }, ka = {width: 70,height: 40,rows: 3,delay: 300,disabled: !1,readonly: !1,showOnFocus: !0,showLabel: !0,wheels: [],theme: "",headerText: "{value}",display: "modal",mode: "scroller",preset: "",lang: "en-US",setText: "Set",cancelText: "Cancel",scrollLock: !0,tap: !0,formatResult: function(a) {
            return a.join(" ")
    ...
    a(document).bind("touchend mouseup", function() {
        ...
        //点击结束触发
        lszh.setValue(false, true);
        console.log(lszh.val+'点击结束了,调用lszh.val即可获得时间')
...
(function(a) {
    var u = a.mobiscroll, k = new Date, o = {dateFormat: "mm/dd/yy",dateOrder: "mmddy",timeWheels: "hhiiA",timeFormat: "hh:ii A",startYear: k.getFullYear() - 100,endYear: k.getFullYear() + 1,monthNames: "January,February,March,April,May,June,July,August,September,October,November,December".split(","),monthNamesShort: "Jan,Feb,Mar,Apr,May,Jun,Jul,Aug,Sep,Oct,Nov,Dec".split(","),dayNames: "Sunday,Monday,Tuesday,Wednesday,Thursday,Friday,Saturday".split(","),dayNamesShort: "Sun,Mon,Tue,Wed,Thu,Fri,Sat".split(","),
        shortYearCutoff: "+10",monthText: "Month",dayText: "Day",yearText: "Year",hourText: "Hours",minuteText: "Minutes",secText: "Seconds",ampmText: "&nbsp;",nowText: "Now",showNow: !1,stepHour: 1,stepMinute: 1,stepSecond: 1,separator: " "}, B = function(k) {
        function t(a, b, d) {
        ...
        var f = a.extend({}, o, C, k.settings), s = 0, C = [], x = [], q = {}, h, A = {y: "getFullYear",m: "getMonth",d: "getDate",h: function(a) {
                a = a.getHours();
                a = D && 12 <= a ? a - 12 : a;
                return l(a, b)
            },i: function(a) {
        ...
        if (v.match(/date/i)) {
            ...
            for (i = 0; 3 > i; i++)
                if (i == q.y) {
                    ...
                    g[f.monthText] = {};
                    for (h = 0; 12 > h; h++)
                        J = B.replace(/[dy]/gi, "").replace(/mm/, 9 > h ? "0" + (h + 1) : h + 1).replace(/m/, h + 1), g[f.monthText][h] = J.match(/MM/) ? J.replace(/MM/, '<span class="dw-mon">' + f.monthNames[h] + "</span>") : J.replace(/M/, '<span class="dw-mon">' + f.monthNamesShort[h] + 
                        "</span>")
                } else if (i == q.d) {
                    s++;
                    g[f.dayText] = {};
        ...
        if (v.match(/time/i)) {
            ...
            for (i = s; i < s + 4; i++)
                if (i == q.h) {
                    s++;
                    g[f.hourText] = {};
                    for (h = 0; h < (D ? 12 : 24); h += b)
                        g[f.hourText][h] = D && 0 == h ? 12 : w.match(/hh/i) && 10 > h ? "0" + h : h
                } else if (i == q.i) {
                    s++;
                    g[f.minuteText] = {};
                    for (h = 0; 60 > 
                    h; h += e)
                        g[f.minuteText][h] = w.match(/ii/) && 10 > h ? "0" + h : h
                } else if (i == q.s) {
                    s++;
                    g[f.secText] = {};
                    for (h = 0; 60 > h; h += d)
                        g[f.secText][h] = w.match(/ss/) && 10 > h ? "0" + h : h
                } else
                    i == q.a && (s++, v = w.match(/A/), g[f.ampmText] = {"0": v ? "上午" : "am",1: v ? "下午" : "pm"});
            C.push(g)
        }
        k.setDate = function(a, b, c, d) {
            for (var e in q)
                this.temp[q[e]] = a[A[e]] ? a[A[e]]() : A[e](a);
            this.setValue(!0, b, c, d)
        };
        k.getDate = function(a) {
            return m(a)
        };
        return {button3Text: f.showNow ? f.nowText : void 0,button3: f.showNow ? function() {
            ...
            headerText: function() {
                ...
                for (c in q)
                    d[q[c]] = b[A[c]] ? b[A[c]]() : A[c](b);
                return d
            },validate: function(c) {
                var g = k.temp, h = {y: H.getFullYear(),m: 0,d: 1,h: 0,i: 0,s: 0,a: 0}, i = {y: L.getFullYear(),m: 11,d: 31,h: l(D ? 11 : 23, b),i: l(59, e),s: l(59, d),a: 1}, j = !0, m = !0;
    ...
    u.formatDate = function(k, t, l) {
        ...
        var l = a.extend({}, o, l), m = function(a) {
            for (var g = 0; r + 1 < k.length && k.charAt(r + 1) == a; )
                g++, r++;
            return g
        }, g = function(a, g, f) {
            g = "" + g;
    ...
    u.parseDate = function(k, t, l) {
        ...
        v = function(a) {
            ...
            for (g = 0; g < a.length; g++)
                if (t.substr(w, a[g].length).toLowerCase() == a[g].toLowerCase())
                    return w += a[g].length, g + 1;
            return 0
        }, w = 0, y;
    ...
    var u = a.mobiscroll, k = {invalid: [],showInput: !0,inputClass: ""}, o = function(o) {
        ...
        function m(a, c, b) {
            ...
            for (; e < a.length; ) {
                i[e] = {};
                d = i[e];
                for (var c = y[e], k = h, l = {}, m = 0; m < k.length; )
                    l[k[m].key] = k[m++].value;
                d[c] = l;
                d = 0;
                for (c = void 0; d < h.length && void 0 === c; ) {
                    if (h[d].key == a[e] && (void 0 !== b && e <= b || void 0 === b))
                        c = d;
                    d++
                }
                if (void 0 !== c && h[c].children)
                    e++, h = h[c].children;
                else if ((f = g(h)) && f.children)
                    e++, h = f.children;
                else
                    break
            }
        ...
        function r(a, c) {
            ...
            if (void 0 !== a[d] && d <= c) {
                f = 0;
                i = a[d];
                for (h = void 0; f < e.length && void 0 === h; )
                    e[f].key == a[d] && !e[f].invalid && (h = f), f++
            } else
                h = g(e, !0), i = e[h].key;
            ...
            for (b[d] = i; f; ) {
                ...
                if (void 0 !== a[d] && d <= c) {
                    ...
                    h = g(e, !0), h = !1 === h ? void 0 : h, i = e[h].key;
        ...
        function i(g) {
            ...
            g.children("li").each(function(b) {
                ...
                var d = d.html().replace(/^\s\s*/, "").replace(/\s\s*$/, ""), g = e.data("invalid") ? !0 : !1, b = {key: e.data("val") || b,value: d,invalid: g,children: null}, e = e.children("ul,ol");
        ...
        var f = a.extend({}, k, o.settings), s = a(this), x, q, h = this.id + "_dummy", A = 0, v = 0, E = {}, w = f.wheelArray || i(s), y = function(a) {
            ...
            for (var c = [], b, e = !0, d = 0; e; )
                if (b = g(a), c[d++] = b.key, e = b.children)
                    a = b.children;
            return c
        }(w), D = m(D, A);
        a("#" + h).remove();
        ...
        return {width: 50,wheels: D,headerText: !1,onBeforeShow: function() {
                var a = o.temp;
                K = 
                a.slice(0);
...
(function(a) {
    ...
    a.mobiscroll.presets.select = function(k) {
        ...
        function U(a, b) {
            ...
            if (g) {
                var d = [], f = 0;
                for (f in k._selectedValues)
                    d.push(E[f]), e.push(f);
                D.val(d.join(", "))
            } else
                D.val(a), e = b ? o(k.values[y]) : null;
        ...
        return {width: 50,wheels: void 0,headerText: !1,multiple: g,anchor: D,formatResult: function(a) {
                return E[o(a[y])]
            },parseValue: function() {
                var c = m.val() || [], b = 0;
                if (g) {
                ...
                if (b === void 0 && g) {
                    ...
                    for (h in d)
                        a(".dwwl" + y + ' .dw-li[data-val="_' + d[h] + '"]', c).addClass("dw-msel")
                }
                if (b === w) {
                    s = o(k.temp[w]);
                    if (s !== f) {
            ...
            onClose: function() {
                D.blur()
            },methods: {setValue: function(c, b, e) {
                    return this.each(function() {
                        var d = a(this).mobiscroll("getInst");
                        if (d)
                            if (d.setSelectVal)
                                d.setSelectVal(c, b, e);
                            else {
                                d.temp = c;
                                d.setValue(true, b, e)
                            }
...
(function(a) {
    a.mobiscroll.themes.jqm = {defaults: {jqmBorder: "a",jqmBody: "c",jqmHeader: "b",jqmWheel: "d",jqmClickPick: "c",jqmSet: "b",jqmCancel: "c"},init: function(u, k) {
            var o = k.settings;
...
(function(a) {
    a.mobiscroll.themes.wp = {defaults: {width: 70,height: 76,accent: "none",dateOrder: "mmMMddDDyy"},init: function(u, k) {
            var o, B;
