var card = {
	...
	preLoad: function() {
		...
		for (var f = 0; f < e; f++) {console.log(card._preLoadPics[f])
...
$(function() {
	...
	var m = null,
		k = "onorientationchange" in window ? "orientationchange" : "resize";
		...
		if (!globalConfig.isLogin) {
			if (window.SINA_OUTLOGIN_LAYER) {
				...
				if ($(".j_share_wb").length > 0) {
					$(".j_share_wb").on("click", function(c) {
						loginLayer.show();
						c.preventDefault()
					})
				}
				loginLayer.register("login_success", function() {
					var c = $(".j_share_wb").data("href");
	...
	document.addEventListener("WeixinJSBridgeReady", function o() {
		window.shareData = {
