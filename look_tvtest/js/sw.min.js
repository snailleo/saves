...
},support:{touch:(window.Modernizr&&Modernizr.touch===true)||(function(){return !!(("ontouchstart" in window)||window.DocumentTouch&&document instanceof DocumentTouch)})(),transforms3d:(window.Modernizr&&Modernizr.csstransforms3d===true)||(function(){var div=document.createElement("div").style;return("webkitPerspective" in div||"MozPerspective" in div||"OPerspective" in div||"MsPerspective" in div||"perspective" in div)})(),transforms:(window.Modernizr&&Modernizr.csstransforms===true)||(function(){var div=document.createElement("div").style;return("transform" in div||"WebkitTransform" in div||"MozTransform" in div||"msTransform" in div||"MsTransform" in div||"OTransform" in div)})(),transitions:(window.Modernizr&&Modernizr.csstransitions===true)||(function(){var div=document.createElement("div").style;return("transition" in div||"WebkitTransition" in div||"MozTransition" in div||"msTransition" in div||"MsTransition" in div||"OTransition" in div)})(),classList:(function(){var div=document.createElement("div");return"classList" in div})()},browser:{ie8:(function(){var rv=-1;if(navigator.appName==="Microsoft Internet Explorer"){var ua=navigator.userAgent;var re=new RegExp(/MSIE ([0-9]{1,}[\.0-9]{0,})/);if(re.exec(ua)!==null){rv=parseFloat(RegExp.$1)}}return rv!==-1&&rv<9})(),ie10:window.navigator.msPointerEnabled,ie11:window.navigator.pointerEnabled}};if(window.jQuery||window.Zepto){(function($){$.fn.swiper=function(params){var firstInstance;this.each(function(i){var that=$(this);var s=new Swiper(that[0],params);if(!i){firstInstance=s}that.data("swiper",s)});return firstInstance}})(window.jQuery||window.Zepto)}if(typeof(module)!=="undefined"){module.exports=Swiper}if(typeof define==="function"&&define.amd){define([],function(){return Swiper})}$(function(){var mySwiper=new Swiper(".swiper-container",{mode:"vertical",noSwiping:true,noSwipingClass:"ok",onInit:function(swiper,direction){var index=swiper.activeIndex;var height=window.innerHeight;var obj=$(".swiper-slide");obj.not(".swiper-slide-visible").find(".look").addClass("hide");obj.eq(index).find(".look").removeClass("hide");obj.eq(index).find(".swiper-container4").addClass("tops");obj.eq(index).find(".swiper-container5").addClass("tops")},onSlideChangeEnd:function(swiper,direction){var index=swiper.activeIndex;var obj=$(".swiper-slide");obj.eq(index).siblings().find(".look").addClass("hide");obj.eq(index).find(".look").removeClass("hide")}});var mySwiper2=new Swiper(".swiper-container2",{autoplay:5000,loop:true,slideClass:"swiper-slide2",onInit:function(swiper,direction){var height=90;var obj=$(".he .swiper-slide");$(".swiper-container2").css({height:"90px"})}});$(".swiper-wrapper").on("click",function(){$(this).removeClass("ok")});var p=document.getElementsByClassName("page1")[0],startTime=null,startY=null,offsetY=null;p.addEventListener("touchstart",function(evt){startTime=new Date()*1;startY=evt.touches[0].pageY;offsetY=0});p.addEventListener("touchmove",function(evt){evt.preventDefault();offsetY=evt.targetTouches[0].pageY-startY});p.addEventListener("touchend",function(evt){var endTime=new Date()*1;var ju=offsetY-startY;if(endTime-startTime<300){if(ju<-50){$(".swiper-wrapper").removeClass("ok");$(".holiday").addClass("tanup");$(".text").addClass("downout");$(".dianqi").addClass("slideRightout");$(".tv").addClass("yao");$(".jiantou").removeClass("hide");document.getElementsByClassName("woman")[0].style.cssText="-webkit-transform: translateX(0%) translateY(80%);-webkit-animation:none;opacity:1;"}}});document.getElementsByClassName("mask_jiche")[0].addEventListener("touchmove",function(e){e.preventDefault();e.stopPropagation()});$(".mask_jiche span").on("click",function(){$(this).addClass("cur");var len=$(".mask_jiche .cur").length;if(len==1){$(".mask_jiche").css({background:"rgba(0,0,0,0.6)"})}else{if(len==2){$(".mask_jiche").css({background:"rgba(0,0,0,0.3)"})}else{if(len==3){$(".mask_jiche").hide();$(".swiper-container3").addClass("tops")}}}document.getElementsByClassName("pointer")[0].style.display="none"})});