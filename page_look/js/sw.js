...
$(function() {
    var mySwiper = new Swiper('.swiper-container', {
        ...
        onInit: function(swiper, direction) {
            ...
            obj.not(".swiper-slide-visible").find(".look").addClass('hide');
            obj.eq(index).find(".look").removeClass("hide");
            // obj.eq(index).find(".swiper-container4").addClass('tops');
            // obj.eq(index).find(".swiper-container5").addClass('tops');
        },
        onSlideChangeEnd: function(swiper, direction) {
            var index = swiper.activeIndex;
            var obj = $(".swiper-slide");
            obj.eq(index).siblings().find(".look").addClass('hide');
            obj.eq(index).find(".look").removeClass("hide");
        }
    })
    ...
    function() {
     ...
     var p = document.getElementsByClassName("page1")[0],
    startTime = null,
    startY = null,
    offsetY = null;
    ...
    function(evt) {
        ...
        var ju = offsetY - startY;
        if (endTime - startTime < 300) {
            if (ju < -50) {
                $('.swiper-wrapper').removeClass('ok');
                $('.holiday').addClass('tanup');
                $('.text').addClass('downout');
                $('.dianqi').addClass('slideRightout');
                $('.tv').addClass('yao');
                $('.jiantou').removeClass('hide');
                document.getElementsByClassName('woman')[0].style.cssText = "-webkit-transform: translateX(0%) translateY(80%);-webkit-animation:none;opacity:1;";
            }
        }
    })
     document.getElementsByClassName("mask_jiche")[0].addEventListener("touchmove",
    function(e) {
        e.preventDefault();
        e.stopPropagation();
    });
    $(".mask_jiche span").on('click',
    function() {
        // $(this).addClass('cur');
        // var len = $(".mask_jiche .cur").length;
        // if (len == 1) {
        //     $(".mask_jiche").css({
        ...
        // } else if (len == 3) {
        //     $(".mask_jiche").hide();
        //     $(".swiper-container3").addClass("tops");
        // }
        $(".mask_jiche").hide();
