...
$(function(){var mySwiper=new Swiper('.swiper-container',{mode:'vertical',noSwiping:true,noSwipingClass:"ok",onInit:function(swiper,direction){var index=swiper.activeIndex;var height=window.innerHeight;var obj=$(".swiper-slide");obj.not(".swiper-slide-visible").find(".look").addClass('hide');obj.eq(index).find(".look").removeClass("hide");},onSlideChangeEnd:function(swiper,direction){var index=swiper.activeIndex;var obj=$(".swiper-slide");obj.eq(index).siblings().find(".look").addClass('hide');obj.eq(index).find(".look").removeClass("hide");}})
var mySwiper2=new Swiper('.swiper-container2',{autoplay:5000,loop:true,slideClass:'swiper-slide2',onInit:function(swiper,direction){var height=90;var obj=$(".he .swiper-slide");$(".swiper-container2").css({height:'90px'});}})
$(".swiper-wrapper").on('click',function(){$(this).removeClass('ok')})
var p=document.getElementsByClassName("page1")[0],startTime=null,startY=null,offsetY=null;p.addEventListener('touchstart',function(evt){startTime=new Date()*1;startY=evt.touches[0].pageY;offsetY=0;});p.addEventListener('touchmove',function(evt){evt.preventDefault();offsetY=evt.targetTouches[0].pageY-startY;});p.addEventListener('touchend',function(evt){var endTime=new Date()*1;var ju=offsetY-startY;if(endTime-startTime<300){if(ju<-50){$('.swiper-wrapper').removeClass('ok');$('.holiday').addClass('tanup');$('.text').addClass('downout');$('.dianqi').addClass('slideRightout');$('.tv').addClass('yao');$('.jiantou').removeClass('hide');document.getElementsByClassName('woman')[0].style.cssText="-webkit-transform: translateX(0%) translateY(80%);-webkit-animation:none;opacity:1;";}}})
document.getElementsByClassName("mask_jiche")[0].addEventListener("touchmove",function(e){e.preventDefault();e.stopPropagation();});$(".mask_jiche span").on('click',function(){$(".mask_jiche").hide();document.getElementsByClassName('pointer')[0].style.display="none";})})